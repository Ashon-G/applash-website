...
export const blog = {
  ...
  date: "2023-07-14",
  title: "Creative ways teams launch with Applash",
  description:
    "Explore how founders package their web apps into mobile experiences using Applash features like push notifications, offline caching, and native integrations.",
  image:
