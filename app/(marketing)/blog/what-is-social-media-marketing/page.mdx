...
export const blog = {
  ...
  date: "2024-07-14",
  title: "How Applash gets your app into the stores",
  description:
    "A behind-the-scenes look at how Applash prepares your web app for the Apple App Store and Google Play with signing, assets, and compliance built in.",
  image:
