...
export const blog = {
  ...
  date: "2022-07-14",
  title: "How companies ship mobile apps without a native team",
  description:
    "Learn how product teams rely on Applash to launch App Store ready builds while keeping their existing web codebase as the single source of truth.",
  image: Thumbnail,
};
