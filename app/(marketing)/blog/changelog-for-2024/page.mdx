...
export const blog = {
  ...
  date: "2024-07-14",
  title: "Applash 2024 Product Changelog",
  description:
    "Track the quarterly Applash upgrades that make converting your web app into native iOS and Android builds faster and more reliable.",
  image:
