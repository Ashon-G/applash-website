...
export const blog = {
  ...
  date: "2020-07-14",
  title: "What is Applash anyway?",
  description:
    "Understand how Applash wraps your web experience in a native container, adds mobile-only capabilities, and keeps deployment effortless.",
  image:
