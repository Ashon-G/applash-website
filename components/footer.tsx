...
export const Footer = () => {
  ...
  const socials = [
    {
      name: "Twitter",
      href: "https://twitter.com/vatasai",
    },
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/vatasai",
    },
    {
      name: "GitHub",
      href: "https://github.com/vatasai",
    },
  ];
  return (
      ...
      <div className="border-t border-neutral-900 px-8 pt-20 pb-32 relative bg-primary">
        <div className="max-w-7xl mx-auto text-sm text-neutral-500 dark:text-neutral-400 flex sm:flex-row flex-col justify-between items-start ">
          <div>
            ...
            <div>Copyright &copy; 2024 Vatas Labs, Inc. Patent Pending.</div>
