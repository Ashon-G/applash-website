  ...
  const content = [
    {
      ...
      description:
        "Authorize LinkedIn, Reddit, X, Slack, and email so vatas surface the warmest conversations automatically.",
      content: (
        <ImageContainer>
          <BlurImage
            src="/first.png"
    ...
    },
    {
      ...
      description:
        "Review every outreach, approve replies, and jump into conversations the moment a vata needs your input.",
      content: (
        <ImageContainer>
          <BlurImage
            src="/second.png"
    ...
    },
    {
      ...
      description:
        "Feed vatas recordings, docs, and analytics so they learn your product, objections, and differentiators on repeat.",
      content: (
        <ImageContainer>
          <BlurImage
    ...
    },
    {
      ...
      description:
        "Track sourced pipeline, win rates, and response speed across every vata from a single dashboard.",
      content: (
        <ImageContainer>
          <BlurImage
            src="/third.png"
  ...
  return (
    ...
    >
      <div className="px-6">
        ...
        <Subheading>
          Spin up vatas, train them with your knowledge, monitor every interaction, and measure pipeline impact without juggling point tools.
        </Subheading>
      </div>
