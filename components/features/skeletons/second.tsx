    ...
    >
      <div className="flex flex-col gap-4 items-center justify-center h-full relative">
        ...
        <svg
          ...
          className="text-neutral-600 hidden"
        >
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute -left-[4.4rem] top-12 hidden"
        >
          <path
            opacity="0.1"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute inset-x-0 -top-2 h-full w-full vertical-dots hidden"
        >
          <path
            opacity="0.1"
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute inset-0 translate-x-4 m-auto h-4 w-4 cursor hidden"
        >
          <path
